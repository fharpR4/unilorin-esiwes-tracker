...
const NAV_ITEMS = {
  [ROLES.STUDENT]: [
    ...
    { href: '/projects/mine', icon: FolderGit2, label: 'My Project' },
      ...
      <nav className="flex-1 p-3 space-y-0.5 overflow-y-auto">
        {navItems.map(({ href, icon: Icon, label }) => {
          ...
          return (
            ...
            >
              <Icon className={cn('h-4 w-4 flex-shrink-0 transition-colors', isActive ? 'text-unilorin-secondary' : 'text-white/50 group-hover:text-white/80')} />
